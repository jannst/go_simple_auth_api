...
type GetUserByNameHandlerFunc func(GetUserByNameParams, *src.Session) middleware.Responder

// Handle executing the request and returning a response
func (fn GetUserByNameHandlerFunc) Handle(params GetUserByNameParams, principal *src.Session) middleware.Responder {
	return fn(params, principal)
}

// GetUserByNameHandler interface for that can handle valid get user by name params
type GetUserByNameHandler interface {
	Handle(GetUserByNameParams, *src.Session) middleware.Responder
}
...
/* GetUserByName swagger:route GET /userinfo User getUserByName
