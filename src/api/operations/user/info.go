...
type InfoHandlerFunc func(InfoParams, *src.Session) middleware.Responder

// Handle executing the request and returning a response
func (fn InfoHandlerFunc) Handle(params InfoParams, principal *src.Session) middleware.Responder {
	return fn(params, principal)
}

// InfoHandler interface for that can handle valid info params
type InfoHandler interface {
	Handle(InfoParams, *src.Session) middleware.Responder
}
...
/* Info swagger:route GET /userinfo User info
