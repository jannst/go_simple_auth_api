...
type LogoutUserHandlerFunc func(LogoutUserParams, *src.Session) middleware.Responder

// Handle executing the request and returning a response
func (fn LogoutUserHandlerFunc) Handle(params LogoutUserParams, principal *src.Session) middleware.Responder {
	return fn(params, principal)
}

// LogoutUserHandler interface for that can handle valid logout user params
type LogoutUserHandler interface {
	Handle(LogoutUserParams, *src.Session) middleware.Responder
}
...
/* LogoutUser swagger:route POST /logout User logoutUser
