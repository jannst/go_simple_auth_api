...
type UserInfoHandlerFunc func(UserInfoParams, *src.Session) middleware.Responder

// Handle executing the request and returning a response
func (fn UserInfoHandlerFunc) Handle(params UserInfoParams, principal *src.Session) middleware.Responder {
	return fn(params, principal)
}

// UserInfoHandler interface for that can handle valid user info params
type UserInfoHandler interface {
	Handle(UserInfoParams, *src.Session) middleware.Responder
}
...
/* UserInfo swagger:route GET /userinfo User userInfo
