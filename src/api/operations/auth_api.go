...
func NewAuthAPI(spec *loads.Document) *AuthAPI {
	return &AuthAPI{
		...
		UserInfoHandler: user.InfoHandlerFunc(func(params user.InfoParams, principal *src.Session) middleware.Responder {
		...
		UserLogoutHandler: user.LogoutHandlerFunc(func(params user.LogoutParams, principal *src.Session) middleware.Responder {
		...
		APIKeyAuthAuth: func(token string) (*src.Session, error) {
...
/*AuthAPI User and Session Management API */
type AuthAPI struct {
	spec            *loads.Document
	...
	APIKeyAuthAuth func(string) (*src.Session, error)

	// APIAuthorizer provides access control (ACL/RBAC/ABAC) by providing access to the request and authenticated principal
	APIAuthorizer runtime.Authorizer

	// UserInfoHandler sets the operation handler for the info operation
	UserInfoHandler user.InfoHandler
...
func (o *AuthAPI) Validate() error {
	...
	if o.UserInfoHandler == nil {
		unregistered = append(unregistered, "user.InfoHandler")
	}
...
func (o *AuthAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/userinfo"] = user.NewInfo(o.context, o.UserInfoHandler)
	...
	o.handlers["POST"]["/logout"] = user.NewLogout(o.context, o.UserLogoutHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
